...
class NhanVien:public QLtaichinh	{
	...
	public:
		...
		void xuat(){
			cout<<setw(10)<<tenNV<<setw(15)<<maNV<<setw(15)<<vitriCV<<setw(15)<<Tuoi<<setw(15)
			<<diachi<<setw(15)<<sdt<<setw(15)<<timelv<<setw(15)<<luong()<<endl;
		}
		float luong(){
			return 20000 * timelv;
		}
...
class KhachHang	{
	...
	public:
		...
		void xuat(){
			cout<<setw(10)<<tenKH<<setw(15)<<tuoi<<setw(15)<<maPhieu<<setw(15)<<sdt;
		}
		friend void menuNL();
		string getMa(){
			return maPhieu;
...
class QlBanHang:public QLtaichinh, public KhachHang{
	...
	public:
		...
		void xuat(){
			KhachHang::xuat();
			cout<<setw(10)<<tenMonAn<<setw(15)<<suatan<<setw(15)<<soluong<<endl;
		}
		float tienBH(){
...
class NguyenLieu:public	QLtaichinh	{
	...
	public:
		...
		void xuat(){
				cout<<setw(10)<<tenNL<<setw(15)<<maNL<<setw(15)<<ngay<<"-"<<thang<<"-"<<nam<<setw(15)
				<<soluong<<setw(15)<<gianhap<<endl;
		}
		float tienMH(){
		...
		switch(chon1)
		{
			...
			case 2:
			{
				system("cls");
			  	...
			  	cout<<setw(10)<<"HOTEN"<<setw(15)<<"TUOI"<<setw(15)<<"MAPHIEU"<<setw(15)<<"SDT"<<endl;
				cout<<"======================================================="<<endl; 
					for(i=0;i<n;i++){
					a[i]->xuat();cout<<endl;
				} 
		...
		switch(chon2)
		{
			...
			case 2:
			{
				system("cls");
			  	...
			  	cout<<setw(10)<<"HOTEN"<<setw(15)<<"MA_NV"<<setw(15)<<"VI_TRI"<<setw(15)<<"TUOI"<<setw(15)
				<<"DIA_CHI"<<setw(15)<<"SDT"<<setw(15)<<"TIME_LV"<<endl;
				cout<<"========================================================================"<<endl; 
				for(i=0;i<n;i++){
					a[i]->xuat();
				} 
...
void menuBH	(QLtaichinh * a[], int n){
	...
	do
	{
		...
		switch(chon3)
		{
			...
			{
				system("cls");
			  	cout<<"\n\t\t-----Danh sach suat an da ban------"<<endl;
			  	cout<<setw(15)<<"HOTEN"<<setw(15)<<"TUOI"<<setw(15)<<"MAPHIEU"<<setw(15)<<"SDT"<<setw(15)
		  		<<"TEN_MONAN"<<setw(15)<<"SUATAN"<<setw(15)<<"SL"<<endl;
		  		cout<<"======================================================================================="<<endl;
				for(i=0;i<n;i++){
					a[i]->xuat();
				} 
		...
		switch(chon4)
		{
			...
			case 2:
			{
				...
				cin.ignore();
			  	...
			  	cout<<setw(10)<<"TEN_NL"<<setw(15)<<"MANL"<<setw(15)<<"NGAY-THANG-NAM"<<setw(15)
				<<"SL"<<setw(15)<<"GIANHAP"<<endl;
				cout<<"==========================================================================="<<endl;
				for(i=0;i<n;i++){
					a[i]->xuat();
				} 
